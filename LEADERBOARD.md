...
[![Evaluation Cycles](https://img.shields.io/badge/Evaluation_Cycles-7-blue?style=flat-square)](https://github.com/festomanolo/Sw-SL)
[![Top Accuracy](https://img.shields.io/badge/Top_Accuracy-97.22%25-success?style=flat-square)](https://github.com/festomanolo/Sw-SL)
...
**Last Automated Verification:** `2026-09-20 03:46:12 UTC`  
...
|:---:|:---|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| **#1** | **BiLSTM + Attention (Proposed)** | Proposed Master Architecture | 604,551 | **`97.22%`** | `97.11%` | — | — | — (Reference) |
| **#2** | **BiGRU + Additive Attention** | Recurrent Baseline | 453,120 | **`93.67%`** | `93.38%` | `1.78` | `0.2978` | ❌ No |
| **#3** | **ST-GCN (Spatial-Temporal Graph)** | Graph Convolution | 512,800 | **`93.56%`** | `93.21%` | `2.08` | `0.2978` | ❌ No |
| **#4** | **Transformer Sequence Encoder** | Attention Baseline | 789,400 | **`93.18%`** | `92.87%` | `2.77` | `0.2883` | ❌ No |
| **#5** | **TCN (Temporal Convolutional Network)** | Temporal Convolution | 342,150 | **`91.45%`** | `91.21%` | `4.27` | `0.1555` | ❌ No |
| **#6** | **Vanilla BiLSTM (No Attention)** | Ablation Baseline | 587,911 | **`88.48%`** | `88.25%` | `9.39` | `0.0109` | ✅ Yes |
...
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **BiLSTM + Attention (Proposed)** | `71.2` | `1.21` | `4.42 ms` | `5.28 ms` | `0.0022` | `13,560` | 🟢 Yes (RTF < 0.01) |
| **BiGRU + Additive Attention** | `53.4` | `0.91` | `3.95 ms` | `4.71 ms` | `0.002` | `15,180` | 🟢 Yes (RTF < 0.01) |
| **ST-GCN (Spatial-Temporal Graph)** | `49.8` | `0.84` | `7.14 ms` | `8.41 ms` | `0.0036` | `8,400` | 🟢 Yes (RTF < 0.01) |
| **Transformer Sequence Encoder** | `86.5` | `1.47` | `5.50 ms` | `6.64 ms` | `0.0027` | `10,860` | 🟢 Yes (RTF < 0.01) |
| **TCN (Temporal Convolutional Network)** | `24.6` | `0.42` | `3.40 ms` | `4.11 ms` | `0.0017` | `17,640` | 🟢 Yes (RTF < 0.01) |
| **Vanilla BiLSTM (No Attention)** | `69.8` | `1.18` | `4.20 ms` | `5.01 ms` | `0.0021` | `14,280` | 🟢 Yes (RTF < 0.01) |
