...
[![Evaluation Cycles](https://img.shields.io/badge/Evaluation_Cycles-10-blue?style=flat-square)](https://github.com/festomanolo/Sw-SL)
...
**Last Automated Verification:** `2026-09-20 20:25:31 UTC`  
...
| **#2** | **BiGRU + Additive Attention** | Recurrent Baseline | 453,120 | **`94.56%`** | `94.31%` | `1.78` | `0.2978` | ❌ No |
| **#3** | **ST-GCN (Spatial-Temporal Graph)** | Graph Convolution | 512,800 | **`93.40%`** | `93.03%` | `2.08` | `0.2978` | ❌ No |
| **#4** | **Transformer Sequence Encoder** | Attention Baseline | 789,400 | **`92.43%`** | `92.09%` | `2.77` | `0.2883` | ❌ No |
| **#5** | **TCN (Temporal Convolutional Network)** | Temporal Convolution | 342,150 | **`91.06%`** | `90.80%` | `4.27` | `0.1555` | ❌ No |
| **#6** | **Vanilla BiLSTM (No Attention)** | Ablation Baseline | 587,911 | **`88.03%`** | `87.78%` | `9.39` | `0.0109` | ✅ Yes |
