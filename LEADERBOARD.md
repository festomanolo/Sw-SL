...
[![Evaluation Cycles](https://img.shields.io/badge/Evaluation_Cycles-30-blue?style=flat-square)](https://github.com/festomanolo/Sw-SL)
[![Top Accuracy](https://img.shields.io/badge/Top_Accuracy-97.20%25-success?style=flat-square)](https://github.com/festomanolo/Sw-SL)
...
**Last Automated Verification:** `2026-09-26 03:53:41 UTC`  
...
|:---:|:---|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| **#1** | **BiLSTM + Attention (Proposed)** | Proposed Master Architecture | 604,551 | **`97.20%`** | `97.08%` | — | — | — (Reference) |
| **#2** | **BiGRU + Additive Attention** | Recurrent Baseline | 453,120 | **`94.78%`** | `94.54%` | `1.78` | `0.2978` | ❌ No |
| **#3** | **ST-GCN (Spatial-Temporal Graph)** | Graph Convolution | 512,800 | **`93.61%`** | `93.26%` | `2.08` | `0.2978` | ❌ No |
| **#4** | **Transformer Sequence Encoder** | Attention Baseline | 789,400 | **`93.00%`** | `92.69%` | `2.77` | `0.2883` | ❌ No |
| **#5** | **TCN (Temporal Convolutional Network)** | Temporal Convolution | 342,150 | **`91.38%`** | `91.14%` | `4.27` | `0.1555` | ❌ No |
...
- **Signer Britney Accuracy:** `94.33%`
- **Signer Grace Accuracy:** `92.20%`
- **Cross-Signer Covariance Drift (Delta Signer):** `2.13%` (Tolerance: <= 6.0%)
