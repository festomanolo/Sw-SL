...
[![Evaluation Cycles](https://img.shields.io/badge/Evaluation_Cycles-23-blue?style=flat-square)](https://github.com/festomanolo/Sw-SL)
...
**Last Automated Verification:** `2026-09-24 11:14:00 UTC`  
...
| **#2** | **BiGRU + Additive Attention** | Recurrent Baseline | 453,120 | **`94.58%`** | `94.33%` | `1.78` | `0.2978` | ❌ No |
| **#3** | **ST-GCN (Spatial-Temporal Graph)** | Graph Convolution | 512,800 | **`93.16%`** | `92.79%` | `2.08` | `0.2978` | ❌ No |
| **#4** | **Transformer Sequence Encoder** | Attention Baseline | 789,400 | **`92.60%`** | `92.26%` | `2.77` | `0.2883` | ❌ No |
| **#5** | **TCN (Temporal Convolutional Network)** | Temporal Convolution | 342,150 | **`91.64%`** | `91.41%` | `4.27` | `0.1555` | ❌ No |
...
| **`habari`** | Greetings / News | 18 | `99.3%` | `93.7%` | **`96.4%`** |
