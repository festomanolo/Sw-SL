...
[![Evaluation Cycles](https://img.shields.io/badge/Evaluation_Cycles-31-blue?style=flat-square)](https://github.com/festomanolo/Sw-SL)
...
**Last Automated Verification:** `2026-09-26 10:55:35 UTC`  
...
| **#2** | **BiGRU + Additive Attention** | Recurrent Baseline | 453,120 | **`94.31%`** | `94.05%` | `1.78` | `0.2978` | ❌ No |
| **#3** | **ST-GCN (Spatial-Temporal Graph)** | Graph Convolution | 512,800 | **`93.68%`** | `93.33%` | `2.08` | `0.2978` | ❌ No |
| **#4** | **Transformer Sequence Encoder** | Attention Baseline | 789,400 | **`92.83%`** | `92.51%` | `2.77` | `0.2883` | ❌ No |
| **#5** | **TCN (Temporal Convolutional Network)** | Temporal Convolution | 342,150 | **`91.41%`** | `91.16%` | `4.27` | `0.1555` | ❌ No |
| **#6** | **Vanilla BiLSTM (No Attention)** | Ablation Baseline | 587,911 | **`88.29%`** | `88.04%` | `9.39` | `0.0109` | ✅ Yes |
...
- **Signer Britney Accuracy:** `95.32%`
- **Signer Grace Accuracy:** `92.37%`
- **Cross-Signer Covariance Drift (Delta Signer):** `2.95%` (Tolerance: <= 6.0%)
