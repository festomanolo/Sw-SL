...
[![Evaluation Cycles](https://img.shields.io/badge/Evaluation_Cycles-5-blue?style=flat-square)](https://github.com/festomanolo/Sw-SL)
...
**Last Automated Verification:** `2026-09-19 15:29:09 UTC`  
...
| **#2** | **BiGRU + Additive Attention** | Recurrent Baseline | 453,120 | **`94.12%`** | `93.84%` | `1.78` | `0.2978` | ❌ No |
| **#3** | **ST-GCN (Spatial-Temporal Graph)** | Graph Convolution | 512,800 | **`93.74%`** | `93.39%` | `2.08` | `0.2978` | ❌ No |
| **#4** | **Transformer Sequence Encoder** | Attention Baseline | 789,400 | **`92.20%`** | `91.84%` | `2.77` | `0.2883` | ❌ No |
| **#5** | **TCN (Temporal Convolutional Network)** | Temporal Convolution | 342,150 | **`90.67%`** | `90.39%` | `4.27` | `0.1555` | ❌ No |
| **#6** | **Vanilla BiLSTM (No Attention)** | Ablation Baseline | 587,911 | **`87.66%`** | `87.39%` | `9.39` | `0.0109` | ✅ Yes |
...
- **Cross-Signer Covariance Drift (Delta Signer):** `2.51%` (Tolerance: <= 6.0%)
