...
[![Evaluation Cycles](https://img.shields.io/badge/Evaluation_Cycles-25-blue?style=flat-square)](https://github.com/festomanolo/Sw-SL)
[![Top Accuracy](https://img.shields.io/badge/Top_Accuracy-96.78%25-success?style=flat-square)](https://github.com/festomanolo/Sw-SL)
...
**Last Automated Verification:** `2026-09-24 21:13:24 UTC`  
...
|:---:|:---|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| **#1** | **BiLSTM + Attention (Proposed)** | Proposed Master Architecture | 604,551 | **`96.78%`** | `96.65%` | — | — | — (Reference) |
| **#2** | **BiGRU + Additive Attention** | Recurrent Baseline | 453,120 | **`94.24%`** | `93.97%` | `1.78` | `0.2978` | ❌ No |
| **#3** | **ST-GCN (Spatial-Temporal Graph)** | Graph Convolution | 512,800 | **`93.44%`** | `93.08%` | `2.08` | `0.2978` | ❌ No |
| **#4** | **Transformer Sequence Encoder** | Attention Baseline | 789,400 | **`92.62%`** | `92.28%` | `2.77` | `0.2883` | ❌ No |
| **#5** | **TCN (Temporal Convolutional Network)** | Temporal Convolution | 342,150 | **`91.16%`** | `90.91%` | `4.27` | `0.1555` | ❌ No |
...
|:---|:---|:---:|:---:|:---:|:---:|
| **`baba`** | Father | 18 | `95.4%` | `100.0%` | **`97.6%`** |
| **`habari`** | Greetings / News | 18 | `99.4%` | `93.8%` | **`96.5%`** |
| **`hedhi`** | Menstruation | 18 | `94.9%` | `94.9%` | **`94.9%`** |
...
- **Signer Britney Accuracy:** `94.51%`
- **Signer Grace Accuracy:** `92.58%`
- **Cross-Signer Covariance Drift (Delta Signer):** `1.93%` (Tolerance: <= 6.0%)
